...
class InvoiceEletronic(models.Model):
 ...
 SEM VALOR FISCAL'
    ...
    def action_post_validate(self):
        ...
        _logger.info("========================mensagens_erro===========================%s", mensagens_erro)
        if mensagens_erro:
        ...
        _logger.info("========================self.xml_to_send_name===========================%s", self.xml_to_send_name)
    ...
    def action_send_eletronic_invoice(self):
        ...
        xml_to_send = base64.decodestring(self.xml_to_send).decode('utf-8', 'ignore')
        import string
